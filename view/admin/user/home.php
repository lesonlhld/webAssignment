                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="box-tools pull-left">
                                <a href="<?= site_url('admin/user/add') ?>"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Add user</button></a>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="<?= site_url('admin/user/view?id=' . $user->id); ?>"><i class="fa fa-eye"></i>View</a></li>
                                                        <li>
                                                            <a href="<?= site_url('admin/user/change_status?id=' . $user->id); ?>"><i class="fa fa-refresh"></i>
                                                                <?= $user->publish == 1 ?
                                                                    'Lock' : 'Unlock'
                                                                ?></a>
                                                        </li>
                                                        <li><a href="<?= site_url('admin/user/edit?id=' . $user->id); ?>"><i class="fa fa-pencil"></i>Edit</a></li>
                                                        <li>
                                                            <a href="<?= site_url('admin/user/remove?id=' . $user->id); ?>" onclick="return confirm('Are you sure you want to remove?');">
                        ...
                        <div class="box-footer clearfix">
                            ...
                            if (isset($data['page'])) {
                                ...
                                if ($page > 1) {
                                    echo '
                      <li><a href="' . site_url("admin/user/index?page=1") . '">&laquo;</a></li>
                      <li><a href="' . site_url("admin/user/index?page=" . ($page - 1)) . '">&lsaquo;</a></li>';
                                }
                                if ($page == 1) {
                                    echo '<li class="active"><a href="' . site_url("admin/user/index?page=$page") . '">' . $page . '</a></li>';
                                } else {
                                    echo '<li><a href="' . site_url("admin/user/index?page=" . ($page - 1)) . '">' . ($page - 1) . '</a></li>
                      <li class="active"><a href="' . site_url("admin/user/index?page=" . $page) . '">' . $page . '</a></li>';
                                }
                                if (count($data['user_list']) == LIMIT) {
                                    echo '<li><a href="' . site_url("admin/user/index?page=" . ($page + 1)) . '">' . ($page + 1) . '</a></li>';
                                    echo '
                      <li><a href="' . site_url("admin/user/index?page=" . ($page + 1)) . '">&rsaquo;</a></li>
                      <li><a href="' . site_url("admin/user/index?page=" . $data['end_page']) . '">&raquo;</a></li>
                      </ul>';
                                }
                            }
                            ?>
