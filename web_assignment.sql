...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2021 lúc 10:12 AM
...
INSERT INTO `orders` (`order_id`, `user_id`, `order_time`, `order_status`, `total`, `payment_id`, `voucher`) VALUES
('0316382620877841', 3, '2021-11-30 15:48:07', 'Initialized', 25000, 2, NULL),
('0316382622383523', 3, '2021-11-30 15:50:38', 'Initialized', 70000, 3, NULL),
('0316382622854350', 3, '2021-11-30 15:51:25', 'Initialized', 35000, 3, NULL);
...
('0316382620877841', 2, 1, 25000),
('0316382622383523', 3, 2, 35000),
('0316382622854350', 3, 1, 35000);
...
(1, 'Phở Bò Tái Chín', 30000, 0, 20, 1, 3, 'Active', '<p>Phở b&ograve; si&ecirc;u ngon, hấp dẫn</p>\r\n', '[]', '16381815064573684.png', 1, 1, 4, 1),
(2, 'Cơm Gà Xối Mỡ', 25000, 40, 0, 1, 2, 'Active', '<p>abc&nbsp;</p>\r\n', '[]', '1608791315663.jpg', 1, 0, 4, 0),
...
(9, 'Bánh Crepe Chuối', 39000, 35, 0, 4, 10, 'Active', '', '[]', '16382431611674802117.jpg', 1, 0, 0, 0),
...
(2, 'Nguyễn Văn ', 'B', '2020-12-03', 'MALE', '0923909321', 'nguyenvana@gmail.com', 'HCM', '7c4a8d09ca3762af61e59520943dc26494f8941b', '1638181586975162336.jpg', 1, 0, 0, 0, NULL),
...
ALTER TABLE `order_items`
  ...
  ADD UNIQUE KEY `fk_order_items_orders_idx` (`order_id`) USING BTREE,
